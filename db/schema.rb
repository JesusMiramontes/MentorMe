...
ActiveRecord::Schema.define(version: 20181126022046) do
  ...
  create_table "professors_topics", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
