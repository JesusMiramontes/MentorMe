...
class ResenasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resena" do
    assert_difference('Resena.count') do
      post resenas_url, params: { resena: { description: @resena.description, professor_id: @resena.professor_id, score: @resena.score, title: @resena.title, user_id: @resena.user_id } }
    end
  ...
  test "should update resena" do
    patch resena_url(@resena), params: { resena: { description: @resena.description, professor_id: @resena.professor_id, score: @resena.score, title: @resena.title, user_id: @resena.user_id } }
